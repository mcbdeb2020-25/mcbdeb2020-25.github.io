...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $query = mysqli_query($con, "INSERT INTO tblusers(FirstName, designation, MobileNumber, Email, Address, ProfilePic) VALUES ('$fname', '$designation', '$contno', '$email', '$add', '$imgnewfile')");
        if ($query) {
...
<div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="contactno" placeholder="Enter your Mobile Number"  maxlength="11" pattern="[0-9]+">
        </div>
        <div class="form-group">
	...
	<div class="text-center">View Aready Inserted Data!!  <a href="view_member.php">View</a></div>
</div>
</body>
