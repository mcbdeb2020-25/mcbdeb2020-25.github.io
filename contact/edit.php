...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "UPDATE tblusers SET FirstName='$fname', designation='$designation', MobileNumber='$contno', Email='$email', Address='$add' WHERE ID='$eid'");

    if ($query) {
        echo "<script>alert('You have successfully updated the data');</script>";
        echo "<script type='text/javascript'> document.location ='view_member.php'; </script>";
    } else {
    ...
    <div class="signup-form">
        <form method="POST">
            ...
            ?>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="contactno" value="<?php echo $row['MobileNumber']; ?>" maxlength="11" pattern="[0-9]+">
                </div>
